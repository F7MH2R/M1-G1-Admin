...
namespace M1_G1_Admin.Controllers
{
    public class PlatosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("plato_id,nombre,descripcion,precio,categoria,disponible,categoria_id")] Platos platos)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("plato_id,nombre,descripcion,precio,categoria,disponible,categoria_id")] Platos platos)
        {
