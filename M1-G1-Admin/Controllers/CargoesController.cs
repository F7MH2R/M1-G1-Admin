...
namespace M1_G1_Admin.Controllers
{
    public class CargoesController : Controller
    {
        ...
        public CargoesController(RestaurantContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("id_cargo,tipo_cargo")] Cargo cargo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id_cargo,tipo_cargo")] Cargo cargo)
        {
